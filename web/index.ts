...
const imageLightOptions: DropdownOption[] = [
    { text: 'Trial & Error', value: 'https://blog.elijahmendoza.nom.za/brand/logo-light-transparent.svg' },
];

const imageDarkOptions: DropdownOption[] = [
    { text: 'Trial & Error', value: 'https://blog.elijahmendoza.nom.za/brand/logo-dark-transparent.svg' },
];
